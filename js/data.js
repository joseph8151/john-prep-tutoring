...
window.JOHN_PREP_DATA = {
  ...
  PARENT_CONCERNS: [
    ...
    { q: "집으로 방문 가능한 선생님을 찾고 있어요.", a: "존프랩튜터링의 핵심 서비스가 바로 1:1 방문수업입니다. 희망 지역과 일정을 상담해드립니다." },
  ...
  FAQ: [
    ...
    { q: "정말 미국·캐나다 원어민 선생님만 있나요?", a: "존프랩튜터링은 미국 또는 캐나다 출신 Native English Speaker를 중심으로 Tutor를 매칭합니다." },
    ...
    { q: "선생님을 제가 직접 고르는 건가요?", a: "아니요. 존프랩은 Tutor Marketplace가 아닙니다. 여러 프로필을 직접 검색하고 선택하시는 구조가 아니라, 매니저 상담을 통해 아이의 조건을 확인한 뒤 적합한 Tutor를 검토하여 소개해드립니다." },
    { q: "정규수업 전에 샘플수업을 받을 수 있나요?", a: "네. 존프랩 매니저 상담 후 적합한 Tutor를 소개받으면 정규수업을 시작하기 전에 샘플수업을 진행할 수 있습니다. 샘플수업을 통해 아이와 Tutor의 호흡, 수업 방식과 난이도를 직접 확인한 후 정규수업 진행 여부를 결정하실 수 있습니다. 지역과 Tutor 일정에 따라 샘플수업 가능 일정이 달라질 수 있습니다." },
